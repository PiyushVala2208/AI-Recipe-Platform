...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    saved_racipes: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-racipe.saved-racipe'
    >;
...
export interface ApiSavedRacipeSavedRacipe extends Struct.CollectionTypeSchema {
  collectionName: 'saved_racipes';
  info: {
    displayName: 'Saved Racipe';
    pluralName: 'saved-racipes';
    singularName: 'saved-racipe';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::saved-racipe.saved-racipe': ApiSavedRacipeSavedRacipe;
