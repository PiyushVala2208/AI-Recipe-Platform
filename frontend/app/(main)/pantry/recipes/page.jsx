...
const PantryRecipesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 pt-22 pb-16 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-6 mt-2">
            <ChefHat className="w-18 h-18 text-green-600" />
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mt-2 text-stone-900 tracking-tight">
                What Can I Cook?
              </h1>
