        ...
        <section className="pb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {COUNTRY_FLAGS.map((area) => (
              ...
              >
                <div className="bg-stone-50 p-5 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all group cursor-pointer flex flex-col items-center justify-center gap-2 min-h-24 text-center">
                  <span className="text-4xl leading-none">{area.emoji}</span>
                  <span className="font-bold text-stone-900 group-hover:text-orange-600 transition-colors text-sm leading-tight">
                    {area.country}
                  </span>
                </div>
              </Link>
